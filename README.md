...
这是一个独立的社区开源项目，**并非 DeepSeek 官方出品**，与 DeepSeek 及其关联方无任何隶属、合作或背书关系。它把官方的 dsh Web 界面装进一个约 1.2 MB 的原生 macOS 窗口里，并代为管理后端服务器进程——不重写官方界面的任何一部分，因此官方的功能演进与 Cordis 插件生态在这里 100% 可用。
