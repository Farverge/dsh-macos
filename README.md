...
选择 MIT 的理由：它给予任何人使用、修改、再分发的最大自由——这正是"一行命令即可开箱即用"的法律前提，且仅要求在副本中保留版权与许可声明。需要说明的是，开源项目若**不放任何许可证**，版权法将默认"保留所有权利"，他人反而无法合法地使用与分发本项目，这与本项目的社区定位相悖；因此一份宽松许可证不是可选项，而是必需品。
